...
object LunaSettingsRegistration {
    ...
    private fun registerConversation() {
        LunaSettings.SettingsCreator.addHeader(ID, "tos_serviceHeader", "API", TAB_CONVERSATION)
        ...
        LunaSettings.SettingsCreator.addString(
            ID, "tos_apiUrl", "API Url", "Url of the endpoint to connect to.",
            "https://openrouter.ai/api/v1/chat/completions", TAB_CONVERSATION
        )
        LunaSettings.SettingsCreator.addString(
            ID, "tos_apiKey", "API Key", "Optional authentification token.",
            "", TAB_CONVERSATION
        )
        LunaSettings.SettingsCreator.addString(
            ID, "tos_apiModel", "API Model", "Model ID for endpoints that serve multiple models.",
            "", TAB_CONVERSATION
        )
        LunaSettings.SettingsCreator.addRadio(
            ID, "tos_reasoningEffort", "Reasoning Effort",
        ...
        LunaSettings.SettingsCreator.addBoolean(
            ID, "tos_guardrailsEnabled", "Add Guardrails",
        ...
        LunaSettings.SettingsCreator.addInt(
            ID, "tos_maxTokens", "Max Response Tokens",
        ...
        LunaSettings.SettingsCreator.addBoolean(
            ID, "tos_persistentMemory", "NPC Memory",
        ...
        LunaSettings.SettingsCreator.addInt(
            ID, "tos_persistentMemoryBudget", "Memory Budget in words",
    ...
    private fun registerSampler() {
        LunaSettings.SettingsCreator.addDouble(
            ID, "tos_temperature", "Temperature",
    ...
    private fun registerToolCalling() {
        LunaSettings.SettingsCreator.addHeader(ID, "tos_toolHeader", "Tool Calling", TAB_TOOL_CALLING)
    ...
    private fun registerCombatChatter() {
        LunaSettings.SettingsCreator.addHeader(ID, "tos_cc_serviceHeader", "Combat Chatter", TAB_COMBAT_CHATTER)
        LunaSettings.SettingsCreator.addBoolean(
            ID, "tos_cc_enabled", "Enable CC Hook",
            "Rewrite combat messages from Combat Chatter by Histidine",
            false, TAB_COMBAT_CHATTER
        )
        LunaSettings.SettingsCreator.addRadio(
            ID, "tos_cc_api", "Service", "",
            "Chat-Completion", HttpApiRegistry.getApiNames().joinToString(), TAB_COMBAT_CHATTER
        )
        LunaSettings.SettingsCreator.addString(
            ID, "tos_cc_apiUrl", "API Url", "Url of the endpoint to connect to.",
            "http://127.0.0.1:8080/v1/chat/completions", TAB_COMBAT_CHATTER
        )
        LunaSettings.SettingsCreator.addString(
            ID, "tos_cc_apiKey", "API Key", "Optional authentification token.",
            "", TAB_COMBAT_CHATTER
        )
        LunaSettings.SettingsCreator.addString(
            ID, "tos_cc_apiModel", "API Model", "Model ID for endpoints that serve multiple models.",
            "", TAB_COMBAT_CHATTER
        )
        LunaSettings.SettingsCreator.addRadio(
            ID, "tos_cc_reasoningEffort", "Reasoning Effort",
            "Only affects models capable of reasoning.",
            "minimal", REASONING_CHOICES, TAB_COMBAT_CHATTER
        )
        LunaSettings.SettingsCreator.addBoolean(
            ID, "tos_cc_onlyRewrite", "Only rewrite chatter",
